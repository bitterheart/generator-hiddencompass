    ...
    module.exports = yeoman.generators.Base.extend({
        ...
        writing: {
            grunt: function (){
                ...
                this.gruntfile.insertConfig("bowerInstall", "{target: {src: \"index.html\", dependencies: true}}");
//                this.gruntfile.insertConfig("express", "{local: {options: {port: 26978, bases: \".\", server: \"server.js\"}}}");
                this.gruntfile.insertConfig("express", "{options: {middleware: function (connect) { return [ mountFolder(connect, \"instrumented\") ];}}}");
                this.gruntfile.insertConfig("protractor_webdriver", "{local:{}}");
                this.gruntfile.insertConfig("instrument", "{files: \"scripts/*.js\", options: { lazy: true, basePath: \"instrumented\"}}");
