...
//                this.gruntfile.insertConfig("pkg","grunt.file.readJSON(\"package.json\")");
                ...
                this.gruntfile.insertConfig("protractor_coverage", "{local:{ options: { configFile: \"protractor.conf.js\", suite: \"local\"}}}");
            },
            app: function () {
                this.fs.copy(
        ...
        install: function () {
            this.npmInstall(["eslint", "grunt-bower-install", "grunt-karma", "karma-html-reporter", "grunt-istanbul-coverage", "grunt-express", "grunt-protractor-webdriver", "grunt-protractor-coverage", "protractor-html-screenshot-reporter"], {"saveDev": true});
